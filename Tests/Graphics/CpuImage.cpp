...
void TestGraphicsCpuImageInit()
{
	...
	cpuImage.FromAllocator(Lt::Graphics::Point2u(800, 600), &allocator);
...
void TestGraphicsCpuImageFrom()
{
	...
	Lt::Graphics::CpuImage src;
	src.FromAllocator(Lt::Graphics::Point2u(800, 600), &allocator);

	Lt::Graphics::CpuImage dst;
	dst.FromMemory(Lt::Graphics::Point2u(800, 600), src.Pixels());
